...
(custom-theme-set-faces
  'mustang 
	...
	'(font-lock-constant-face ((t (:foreground "#ff9800"))))
        ...
        '(org-level-1 ((t (:bold t :foreground "#8b8bcd" :height 1.2))))
        ...
        '(org-date ((t (:underline t :foreground "#f0ad6d") :height 1.4)))
        '(org-footnote  ((t (:underline t :foreground "#ad600b"))))
        '(org-link ((t (:underline t :foreground "#808bed" ))))
        ...
        '(org-agenda-date ((t (:foreground "#409090" :height 1.4))))
        '(org-agenda-date-weekend ((t (:weight normal :foreground "8b8bcd"))))
        '(org-agenda-date-today ((t (:weight bold :foreground "#cd8b00" :height 1.4))))
